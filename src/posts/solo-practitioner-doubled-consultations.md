---
title: How One Solo Practitioner Doubled Consultations in 90 Days
description: A solo estate planning attorney doubled her monthly consultations in 90 days without increasing her budget. A breakdown of exactly what changed across infrastructure, conversion, and referrals.
date: 2025-12-01
category: Case Studies
readTime: 9
author: David Reynolds
excerpt: A breakdown of the specific changes made across infrastructure, conversion, and referral development that led to a measurable uplift in qualified consultations within a single quarter.
permalink: /solo-practitioner-doubled-consultations/
layout: article.njk
breadcrumbLabel: Case Study
toc:
  - id: starting-point
  ...
  - id: phase-2
    label: Phase 2 - Conversion
  - id: phase-3
    label: Phase 3 - Referrals
  - id: results
    label: The Results
  - id: what-it-means
...
<p class="article-intro">This case study follows a solo estate planning attorney in a mid-size Midwestern market who doubled her monthly consultation volume over a single quarter without increasing her marketing budget. The changes she made were specific, sequenced, and reproducible.</p>

## Where She Started {#starting-point}
...
## Phase 1: Fix the Infrastructure (Days 1 to 30) {#phase-1}
...
## Phase 2: Improve Conversion on Existing Inquiries (Days 31 to 60) {#phase-2}
...
## Phase 3: Build New Referral Relationships (Days 61 to 90) {#phase-3}
...
## The Results After 90 Days {#results}
...
## What This Case Study Actually Demonstrates {#what-it-means}
...
<div class="callout">
  <h3>The Replicable Elements</h3>
  <ul>
    <li>Complete your Google Business Profile fully before doing anything else in local search</li>
    <li>Set up a review request workflow tied to matter closure, not a manual process</li>
    <li>Audit your inquiry response process: how fast, how personal, how consistent</li>
    <li>Implement a CRM before adding marketing activity, not after</li>
    <li>Add a follow-up sequence for non-converting inquiries: most firms have none</li>
    <li>Identify one category of non-attorney referral source and contact five of them this quarter</li>
    <li>Measure your inquiry-to-consultation conversion rate: if you don't know it, find out before spending on anything else</li>
  </ul>
</div>
